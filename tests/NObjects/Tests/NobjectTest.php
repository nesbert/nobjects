...
class NobjectTest extends \PHPUnit_Framework_TestCase
{
    public function testObjectHelpers()
    {
        ...
        $obj = new \NObjects\Nobject();
        $this->assertTrue($obj instanceof Nobject);
        ...
        $obj2 = new \NObjects\Nobject($data);
        $this->assertTrue($obj2 instanceof Nobject);
        ...
        $data3 = array(
            ...
            'favorites' => new \NObjects\Nobject((object)array('toy'=>'Legos')),
        );

        $data3['nested'] = $data3;

        $obj3 = new \NObjects\Nobject($data3);

        $this->assertTrue($obj3 instanceof Nobject);
        ...
        $obj4  = new \NObjects\Nobject($data4);
        $this->assertTrue($obj4 instanceof Nobject);
    ...
    {
        $ancestors = Nobject::ancestors('Nobject');
        $this->assertTrue(empty($ancestors));

        $ancestors = Nobject::ancestors('\NObjects\DateTime');
    ...
    public function testTypeHintingHelpers()
    {
        ...
        // Nobject instance
        $valType = 'NObjects\Tests\Objects\Fake\FooThree';
        $this->assertEquals(
    ...
    /**
     * @covers \NObjects\Nobject::toJSON
     */
    ...
    /**
     * @covers \NObjects\Nobject::__toString
     */
    ...
    /**
     * @covers \NObjects\Nobject::toArray
     */
